...
#Windows API get's you flagged by the game's Anti-Cheat (DO NOT USE IT ONLINE)

import win32api, win32con

def main():
    # Window title to go after and the height of the screenshots, including spaces (inactive windows won't work, type the original active window)
    videoGameWindowTitle = "PAYDAY 2"
    ...
    while win32api.GetAsyncKeyState(ord(aaQuitKey)) == 0:
        ...
        if visuals:
            cv2.imshow('Aimbot Vision', npImg)
